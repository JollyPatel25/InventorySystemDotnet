        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictionForDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Predictions_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWarehouseAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserWarehouseAssignments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserWarehouseAssignments_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_TaxIdentificationNumber",
                table: "Organizations",
                column: "TaxIdentificationNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_ProductId_WarehouseId_PredictionForDate",
                table: "Predictions",
                columns: new[] { "ProductId", "WarehouseId", "PredictionForDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_ProductId_WarehouseId_PredictionForDate_Created~",
                table: "Predictions",
                columns: new[] { "ProductId", "WarehouseId", "PredictionForDate", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_WarehouseId",
                table: "Predictions",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_OrganizationId_InvoiceNumber",
                table: "Sales",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAdjustments_InventoryId_CreatedAt",
                table: "StockAdjustments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrganizations_UserId_IsDefault",
                table: "UserOrganizations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWarehouseAssignments_UserId_WarehouseId",
                table: "UserWarehouseAssignments",
                columns: new[] { "UserId", "WarehouseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserWarehouseAssignments_WarehouseId_IsActive",
                table: "UserWarehouseAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_OrganizationId_IsActive",
                table: "Warehouses",
                columns: new[] { "OrganizationId", "IsActive" });
        }
