...
// Manager sales reuses the same logic as org sales
// Import and render org sales component directly
...
@Component({
  ...
  imports: [
    ...
    MatSnackBarModule, PageHeaderComponent, DataTableComponent
  ],
