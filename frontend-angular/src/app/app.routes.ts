    ...
    children: [
      ...
      // Org Admin
      {
        ...
        children: [
          ...
          { path: 'tax', loadComponent: () => import('../features/org/tax/tax.component').then(m => m.TaxComponent) },
          { path: 'reports', loadComponent: () => import('../features/org/reports/reports.component').then(m => m.ReportsComponent) },
...
//         children: [
//           { path: 'dashboard', loadComponent: () => import('../features/org/dashboard/dashboard.component').then(m => m.DashboardComponent) },
//           { path: 'products', loadComponent: () => import('../features/org/products/products.component') },
//           { path: 'warehouses', loadComponent: () => import('../features/org/warehouses/warehouses.component').then(m => m.WarehousesComponent) },
//           { path: 'inventory', loadComponent: () => import('../features/org/inventory/inventory.component').then(m => m.InventoryComponent) },
//           { path: 'sales', loadComponent: () => import('../features/org/sales/sale.component').then(m => m.SalesComponent) },
